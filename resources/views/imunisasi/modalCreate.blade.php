<!-- <MODAL IMUNISASI> --> 
<div class="modal fade" id="modal-imunisasi-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="col-12 section">
          <div class="line mb-5"></div>
            <div class="mb-3">
              ...
              <input autocomplete="off" type="date" class="form-control @error('tgl_imunisasi') is-invalid @enderror" name="tgl_imunisasi"  id="tgl_imunisasi" value="{{ old('tgl_imunisasi') }}">
                @error('tgl_imunisasi')
