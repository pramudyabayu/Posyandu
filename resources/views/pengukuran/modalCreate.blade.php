<!-- <MODAL PENGUKURAN> -->
<div class="modal fade" id="modal-pengukuran-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col-12 d-flex form-container mb-5">
              <div class="col-6 left-form">
                ...
                <div class="mb-3">
                  ...
                  <select name="balita_id" class="custom-select mr-sm-2 @error('balita_id') is-invalid @enderror" id="balita_id">
              ...
              <div class="col-6 right-form">
                ...
                <div class="mb-3">
                  ...
                  <select name="sumber_pmt" class="custom-select mr-sm-2 @error('sumber_pmt') is-invalid @enderror" id="sumber_pmt">
