          ...
          <table class="table align-items-center table-flush">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{date('d F Y',strtotime($item->tgl_pelayanan))}}</td><td>{{$item->balita->nama_balita}}</td>
                <td>{{$item->usia}}</td>
                <td>{{$item->bb}}</td>
                <td>{{$item->tb}}</td>
                ...
                <td>
                  ...
                  <a href="#modal-pengukuran-edit" class="btn btn-primary" data-toggle="modal" data-placement="left" ><i class="bi bi-pencil-square"></i></a>
                </td>
              </tr>
              @endforeach
            </tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-12 section">
          <div class="line mb-5"></div>
          <form action="/pengukuran/{{$item->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="col-12 d-flex form-container mb-5">
              <div class="col-6 left-form">
