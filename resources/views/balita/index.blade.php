           ...
           <div class="col-12 section">
             <div class="line mb-5"></div>
              ...
              <div class="col-6 right-form">
                <div class="mb-4">
                    <label for="kia" class="form-control-label">KIA (Kesehatan Ibu dan Anak)</label><br>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"type="radio" name="kia" value="Ya" id="kia1">
                  ...
                  <div class="mb-3">
                    <label for="imd" class="form-control-label">IMD (Inisiasi Menyusu Dini)</label><br>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"type="radio" name="kia" value="Ya" id="imd1">
                        <label class="form-check-label" for="imd1">Ya</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"type="radio" name="kia" value="Tidak" id="imd2">
