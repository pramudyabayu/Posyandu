        ...
        <div class="card-header">
          <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
              <button id="#btn-add" data-target="#modal-jadwal-create" class="btn-add btn btn-primary btn-sm" data-toggle="modal" data-placement="left" title="Tambah Jadwal Pelayanan"><i class="bi bi-plus-circle"></i></button>
          </div>
          </div>
        </div>
        <!-- Light table -->
